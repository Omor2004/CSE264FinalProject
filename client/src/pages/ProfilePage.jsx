...
const ProfilePage = () => {
  ...
  return (
    ...
    {/* Right ads: show if user exists and paid is false */}
      {currentUser && currentUser?.paid === false && (
